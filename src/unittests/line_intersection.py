...
from src.simple_commander.utils.line_intersection import line_intersection
...
class MainControllerTestCase(unittest.TestCase):
    ...
    def test_intersection_1(self):
        ...
        C = (1, 3)
        D = (3, 1)
        int_point = line_intersection((A, B), (C, D), round(self.unit1['width'] / 2), round(self.unit2['width'] / 2))
